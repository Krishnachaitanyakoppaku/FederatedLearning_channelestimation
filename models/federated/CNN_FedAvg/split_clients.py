...
if __name__ == "__main__":
    ...
    parser.add_argument('--x_path', type=str, default='../../../data/splits/10dB/X_train.npy', help='Path to noisy training data (default 10dB/X_train)')
    parser.add_argument('--y_path', type=str, default='../../../data/splits/10dB/Y_train.npy', help='Path to clean training data (default 10dB/Y_train)')
