...
if __name__ == "__main__":
    ...
    parser.add_argument('--x_test', type=str, default='../../../data/splits/10dB/X_test.npy', help='Path to test noisy channel')
    parser.add_argument('--y_test', type=str, default='../../../data/splits/10dB/Y_test.npy', help='Path to test clean channel')
