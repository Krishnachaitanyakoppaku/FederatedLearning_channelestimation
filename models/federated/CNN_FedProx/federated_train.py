...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--x_test", type=str, default="../../../data/splits/10dB/X_test.npy", help="Test input path")
    parser.add_argument("--y_test", type=str, default="../../../data/splits/10dB/Y_test.npy", help="Test target path")
