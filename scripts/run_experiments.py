...
def run_phase2(config_path: Path):
    ...
    for seed in cfg.seeds:
        run_cmd(
            ...
            PROJECT_ROOT / "models" / "centralized" / "CNN",
        )
        ...
        run_cmd(
            ...
            PROJECT_ROOT / "models" / "centralized" / "ResUNet",
        )
...
def run_phase3(config_path: Path):
    ...
    x_train = f"../../../data/splits/{cfg.snr_db}dB/X_train.npy"
    y_train = f"../../../data/splits/{cfg.snr_db}dB/Y_train.npy"
    x_test = f"../../../data/splits/{cfg.snr_db}dB/X_test.npy"
    y_test = f"../../../data/splits/{cfg.snr_db}dB/Y_test.npy"
    ...
    run_cmd(
        ...
        PROJECT_ROOT / "models" / "federated" / "CNN_FedAvg",
    )
    run_cmd(
        [
            PYTHON_BIN,
        ...
        PROJECT_ROOT / "models" / "federated" / "CNN_FedProx",
    )
...
def run_phase4():
    run_cmd([PYTHON_BIN, "scripts/aggregate_results.py"], PROJECT_ROOT)
