...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--dataset_dir", type=str, default="data/splits/10dB", help="Dataset dir for latency benchmarking")
...
def _load_model_param_counts() -> Dict[str, int]:
    try:
        sys.path.append(str(PROJECT_ROOT / "models" / "centralized" / "CNN"))
        sys.path.append(str(PROJECT_ROOT / "models" / "centralized" / "ResUNet"))
