...
- [ ] Re-run figure generation in clean environment
...
- [ ] Validate README execution instructions
- [ ] Archive configs/logs/summaries/figures
- [ ] Prepare appendix: hyperparameters + compute budget
